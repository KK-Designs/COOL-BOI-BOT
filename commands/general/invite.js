module.exports = {
	...
	execute(message, args) {
		...
		const buttonInvite1 = new MessageActionRow()
			.addComponents(
				new MessageButton()
		...
		message.channel.send({ content: 'To invite the bot, please click one the buttons below (admin link recommened)', components: [ buttonInvite, buttonInvite1 ], reply: { messageReference: message.id } });
	},
};