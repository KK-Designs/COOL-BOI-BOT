			...
			return message.reply({
				embeds: [
					new MessageEmbed()
						...
						.setDescription(
							'<:check:807305471282249738> Reset the bots prefix to `!`',
						),
				],
			});
		}
			...
			return message.reply({
				embeds: [
					new MessageEmbed()
						.setColor(color.fail)
						.setDescription(
							'<:X_:807305490160943104> I can\'t set the prefix to anything more than 3',
						),
				],
			});
		}
			...
			message.reply({
				embeds: [
					new MessageEmbed()
						.setColor(color.success)
						.setDescription(
							`<:check:807305471282249738> Prefix was succesfully changed to ${args[0]}\n\n *you can check the new prefix by running '<@811024409863258172> prefix'*`,
						),
				],
			});
			setTimeout(() => {
