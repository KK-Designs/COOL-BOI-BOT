...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    let member = message.mentions.members.last() || message.guild.members.cache.get(args[0]) || message.member;
    if (!role)
      return sendError('Please provide a valid role', message.channel);
