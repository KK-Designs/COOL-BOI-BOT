module.exports = {
  ...
  async execute(message) {
    ...
    if (!serverQueue?.playing)
      return message.reply({content: '<:no:803069123918823454> There is nothing playing.'});
  ...
  async executeSlash(interaction) {
    ...
    if (!serverQueue?.playing)
      return await interaction.reply({content: '<:no:803069123918823454> There is nothing playing.'});
