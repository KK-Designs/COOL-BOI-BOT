...
module.exports = {
  ...
  async	execute(message, args) {
    ...
    if (res.nsfw && !(message.channel.nsfw ?? true))
      return await message.reply({content: 'This current meme is a NSFW meme. To see it, go to a nsfw channel'});
  ...
  async	executeSlash(interaction) {
    ...
    if (body.nsfw && !(interaction.channel.nsfw ?? true))
      return await interaction.reply({content: 'This current meme is a NSFW meme. To see it, go to a nsfw channel'});
